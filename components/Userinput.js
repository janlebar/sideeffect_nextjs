...
/>
      ...
      <button className="bg-white hover:bg-white-100 text-blue-400 hover:text-blue-500 font-bold py-2 px-4 rounded-md ml-4 mt-1 mr-10" onClick={handleAddInput}>Add Input</button>
